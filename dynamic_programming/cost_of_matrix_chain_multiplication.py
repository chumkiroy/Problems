...
Output Format: Return an integer minOps, denoting the minimum number of operations needed.
...
def matrixChainMultiplication(arr, n):
...
arr = [1,2,3,4]
print matrixChainMultiplication(arr, len(arr))
